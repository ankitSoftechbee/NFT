...
const DepositHistory = () => {
    ...
    const {
        ...
        isError,
        error,
    } = metaBullApi.useDepositHistoryQuery({
                            ...
                            <div className="flex flex-col space-y-3">
                                ...
                                <div className="grid grid-cols-2 gap-2 text-gray-300 text-sm">
                                    <div>
                                        ...
                                        <p>{new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(item.paidAmount)}</p>
                                    </div>
                                    <div>
                                ...
                                <div className="grid grid-cols-2 gap-2 text-gray-300 text-sm">
                                    <div>
                                        ...
                                        <p>{formatDate(item.dateOfRequest)}</p>
                                    </div>
                                    <div>
                                        <span className="text-gray-500">Action Date</span>
                                        <p>{formatDate(item.dateofAction)}</p>
                                    </div>
                                </div>
